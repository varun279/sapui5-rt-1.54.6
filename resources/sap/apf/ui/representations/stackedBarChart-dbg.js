...
(function() {
	...
	sap.apf.ui.representations.stackedBarChart = function(oApi, oParameters) {
		...
		this.chartType = sap.apf.ui.utils.CONSTANTS.vizFrameChartTypes.STACKED_BAR;
	...
	*/
	sap.apf.ui.representations.stackedBarChart.prototype._addDefaultKind = function() {
	...
	*/
	 ...
	 */
	sap.apf.ui.representations.stackedBarChart.prototype.setVizPropsForSpecificRepresentation = function() {
	...
	*/
	sap.apf.ui.representations.stackedBarChart.prototype.setVizPropsOfThumbnailForSpecificRepresentation = function() {
		_setVizPropsCommonToMainAndThumbnailCharts(this.thumbnailChart);
	};
	sap.apf.ui.representations.stackedBarChart.prototype.getAxisFeedItemId = function(sKind) {
