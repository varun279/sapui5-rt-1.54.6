...
sap.ui.define([
    ...
    jQuery.extend(module, {
        ...
        init: function() {
            ...
            sap.ushell.Container.getService("Search").prefetchTiles();
                ...
                onAfterRendering: function() {
                    ...
                    domRef.addEventListener('focus', function(event) {
                        ...
                        if (that.oShellHeader.getSearchState() === 'EXP_S' && !that.isNoSearchResultsScreen()) {
                            var parentHeader = that.oShellHeader.getParent();
                            if (!parentHeader.hasStyleClass("sapUshellShellShowSearchOverlay")) {
                                parentHeader.addStyleClass("sapUshellShellShowSearchOverlay")
                            }
                            return;
                        }
                    ...
                    domRef.addEventListener('blur', that.makeDelayed(function(event) {
                        ...
                        var parentHeader = that.oShellHeader.getParent();
                        parentHeader.removeStyleClass("sapUshellShellShowSearchOverlay");
        ...
        setSearchState: function(state, suppresFocus) {
            ...
            switch (state) {
                ...
                case 'EXP':
                    ...
                    this.oShellHeader.setSearchState(state, 35, !this.isNoSearchResultsScreen());
                    this.oSearchCancelButton.setVisible(true);
                    sap.ui.getCore().byId('sf').setVisible(false);
                    if (!suppresFocus) {
