        ...
        return core.defineClass({
            ...
            _initAsync: function (configuration) {
                ...
                return this.loadServerInfo().then(function (serverInfo) {
                    ...
                    return {
                        capabilities: this.sina._createCapabilities({ fuzzy: this.supports('Search', 'OptionFuzzy') })
                    };
                }.bind(this));
            },
            ...
            loadBusinessObjectDataSources: function () {
                this.addLanguagePreferences(ajaxTemplates.loadDataSourcesRequest);
                return this.ajaxClient.postJson(this.getResponseUrl, ajaxTemplates.loadDataSourcesRequest).then(function (response) {
                    ...
                    for (var i = 0; i < dataSourcesData.length; ++i) {
                        ...
                        var dataSource = this.sina._createDataSource({
                            ...
                            attributesMetadata: [{ id: 'dummy' }] // fill with dummy attribute
                        });
            ...
            assembleOrderBy: function (query) {
                ...
                for (var i = 0; i < query.sortOrder.length; ++i) {
                    ...
                    result.push({ AttributeName: sortKey.id, SortOrder: sortOrder });
                }
                return result;
            },
            ...
            executeSearchQuery: function (query) {
                ...
                // fire request
                return this.ajaxClient.postJson(this.getResponseUrl, ajaxTemplates.searchRequest).then(function (response) {
                    return this.itemParser.parse(query, response.data).then(function (parsedItems) {
                        var parsedFacets = this.facetParser.parse(query, response.data);
            ...
            executeChartQuery: function (query) {
                ...
                return this.ajaxClient.postJson(this.getResponseUrl, ajaxTemplates.chartRequest).then(function (response) {
                    var facets = this.facetParser.parse(query, response.data);
                    return facets[0];
                }.bind(this));
            },
            ...
            addSessionId: function (request) {
                if (!this.supports('Search', 'SessionHandling')) {
                    delete request.SessionID; delete request.SessionTimestamp; return;
                }
            ...
            addLanguagePreferences: function (request) {
                if (!this.supports('Search', 'LanguagePreferences')) {
                    delete request.LanguagePreferences; return;
                }
            ...
            getConfigurationAsync: function () {
                ...
                return this.ajaxClient.postJson(this.getResponseUrl, ajaxTemplates.getConfigurationRequest).then(function (response) {
                    var config = { personalizedSearch: false, personalizedSearchIsEditable: false };
