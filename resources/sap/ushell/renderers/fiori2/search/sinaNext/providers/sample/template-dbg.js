...
sinaDefine([], function() {
    ...
    return function(oContext) {
        ...
        if (oContext.sina) {
            ...
            gen.metadata = [
                oContext.sina._createAttributeMetadata({
                    ...
                    usage: {
                        Title: 'Title',
                        AdvancedSearch: { displayOrder: 0 } //necessary to open showmore dialog
                    },
                    isSortable: true,
                    isKey: false,
            ...
            gen.metadata2 = [
                ...
                oContext.sina._createAttributeMetadata({
                    ...
                    type: oContext.sina.AttributeType.Longtext,
                    usage: 'detail',
                    isSortable: true,
                    isKey: false,
                    matchingStrategy: oContext.sina.MatchingStrategy.Exact
        ...
        if (oContext.searchQuery && oContext.searchQuery.filter && oContext.searchQuery.filter.dataSource && oContext.sina && oContext.NavigationTarget) {
            ...
            /*
             *
             *     'scientists' searchResultSetItem 2:Robert Sarmast
             *
             *
             */
            ...
            titleAttributes = [oContext.sina._createSearchResultSetItemAttribute({
                ...
                isHighlighted: false,
                label: 'Scientist',
                value: 'Robert Sarmast',
                valueFormatted: 'Robert Sarmast',
                metadata: gen.getMetadataById(gen.metadata, "SCIENTIST")
            })];
            ...
            /*
             *
             *     'scientists' searchResultSetItem 3:Zecharia Sitchin
             *
             *
             */
            ...
            titleAttributes = [oContext.sina._createSearchResultSetItemAttribute({
                ...
                isHighlighted: false,
                label: 'Scientist',
                value: 'Zecharia Sitchin',
                valueFormatted: 'Zecharia Sitchin',
                metadata: gen.getMetadataById(gen.metadata, "SCIENTIST")
            })];
            ...
            /*
             *
             *     'scientists' searchResultSetItem 4:Alan F. Alford
             *
             *
             */
            ...
            detailAttributes = [
                ...
                oContext.sina._createSearchResultSetItemAttribute({
                    ...
                    valueHighlighted: '',
                    isHighlighted: false,
                    label: 'Alan F. Alford (Eridu Books)',
            ...
            /*
             *
             *     'scientists' searchResultSetItem 5:Klaus Schmidt
             *
             *
             */
            ...
            detailAttributes = [
                ...
                oContext.sina._createSearchResultSetItemAttribute({
                    ...
                    valueHighlighted: '',
                    isHighlighted: false,
                    label: 'Klaus Schmidt (Institut für Ur- und Frühgeschichte, Erlangen)',
            ...
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                ...
                detailAttributes: detailAttributes,
                defaultNavigationTarget: new oContext.NavigationTarget({
                    label: 'Robert Sarmast on the Hunt for Atlantis',
            ...
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                //attributes: [firstName],
                dataSource: oContext.sina.getDataSource("Mysterious_Sightings"),
                title: 'Humanity\'s first "Cathedral on a Hill."',
                titleHighlighted: '',
                titleAttributes: titleAttributes,
                detailAttributes: detailAttributes,
                defaultNavigationTarget: new oContext.NavigationTarget({
