...
sap.ui.define(function() {
    ...
    var oModelData = {
        ...
        userImage: {
            personPlaceHolder : sap.ui.core.IconPool.getIconURI("person-placeholder"),
    ...
    function AppLifeCycle() {
        ...
        this.init = function(oConfig){
            ...
            if(oConfig){
                jQuery.sap.measure.start("FLP:AppLifeCycle.init", "moveShellHeaderEndItems","FLP");
                ...
                jQuery.sap.measure.end("FLP:AppLifeCycle.init");
            }
            this.createDefault();
        ...
        this._attachPressToUserSettings = function(){
            jQuery.sap.measure.start("FLP:AppLifeCycle._attachPressToUserSettings", "_attachPressToUserSettings","FLP");
            ...
            jQuery.sap.measure.end("FLP:AppLifeCycle._attachPressToUserSettings");
        };
        ...
        this._addHeaderItemInCorrectOrder = function (sPropertyString, aId, bCurrentState, aStates) {
            ...
            function fnUpdate(modelPropertyString, aIdsToAdd, oCurrentModel) {
                jQuery.sap.measure.start("FLP:AppLifeCycle.fnUpdate", "update shell head end items","FLP");
                ...
                jQuery.sap.measure.end("FLP:AppLifeCycle.fnUpdate");
            }
    ...
    var AppLifeCycle1 = new AppLifeCycle();

	return AppLifeCycle1;
