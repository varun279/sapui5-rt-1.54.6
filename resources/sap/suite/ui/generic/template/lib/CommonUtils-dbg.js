	...
	function getMethods(oController, oServices, oComponentUtils) {
		...
		*/
		...
		function fnGetBreakoutActions(oControl) {
			...
			var sBindingPath = (isSmartTable(oControl) ? oControl.getTableBindingPath() : "");
			sBindingPath = sBindingPath || (isSmartChart(oControl) ? oControl.getChartBindingPath() : "" );
			if (!sBindingPath){ 
				...
				var sAnnotationPath = sBindingPath + (isSmartTable(oControl) ? "::com.sap.vocabularies.UI.v1.LineItem" : "::com.sap.vocabularies.UI.v1.Chart");
				return oSections && oSections[sAnnotationPath] && oSections[sAnnotationPath].Actions;
			}
		}
