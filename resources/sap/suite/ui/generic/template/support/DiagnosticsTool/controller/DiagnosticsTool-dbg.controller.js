sap.ui.define([
	 ...
	 */
	var fnOnCopyDataPlain = function () {
	...
	var fnOnCopyDataHTML = function () {
		...
		//sContent += sPrefix + "Application URL: " + (sCurrentURL ? "<a href=\"" + sCurrentURL + "\">" + sCurrentURL + "</a>" : "unknown") + sSuffix;
	 ...
	 */
	var fnApplyCustomLayout = function () {
		...
		for (var i = 0; i < $GroupHeaders.length; i++) {
			var sCellId = $GroupHeaders[i].closest("td").id;
			var $Cell = jQuery("#" + sCellId);
	 ...
	 */
	var fnUpdateStatus = function (iTime, sStatus) {
		var oModel = this.getView().getModel("data");
	 ...
	 */
	var fnShowDataRefreshed = function () {
