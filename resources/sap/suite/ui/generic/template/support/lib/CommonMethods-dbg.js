...
sap.ui.define([], function () {
	 ...
	 */
	var fnGetDynamicComparator = function (sProperty) {
	 ...
	 */
	var fnGetFileFromURI = function (sPath) {
		if (sPath) {
	 ...
	 */
	var fnIsValidApplicationStatus = function (sStatus) {
	 ...
	 */
	var fnGetApplicationStatus = function () {
	 ...
	 */
	var fnSetApplicationStatus = function (sStatus) {
	 ...
	 */
	var fnGetAppComponent = function () {
	 ...
	 */
	var fnSetAppComponent = function (oComponent) {
	 ...
	 */
	var fnPublishEvent = function (sChannel, sEvent, oData) {
	 ...
	 */
	var fnConcatStrings = function (aStrings) {
	 ...
	 */
	var fnHasObjectContent = function (oObject) {
		if (!oObject) {
			return false;
		}
	 ...
	 */
	var fnGetApplicationName = function (sURL) {
		if (!sURL) {
			return "";
		}
	 ...
	 */
	var fnShortenURL = function (sURL) {
		if (!sURL) {
			return "";
		}
