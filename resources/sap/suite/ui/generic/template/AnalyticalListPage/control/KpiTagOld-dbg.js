sap.ui.define([
	...
	return Control.extend("sap.suite.ui.generic.template.AnalyticalListPage.control.KpiTagOld", {
		metadata: {
			properties: {
				value: {
					type: "string",
			...
			if (this._firstTime) {
				...
				if (this.getModelName()) {
					...
					oModel.getMetaModel().loaded().then(function() {
						...
						var oSelectionVariantPath = oSelectionPresentationVariant.SelectionVariant && (oSelectionPresentationVariant.SelectionVariant.Path || oSelectionPresentationVariant.SelectionVariant.AnnotationPath);
