sap.ui.define([
	...
	], function(jQuery, Controller, Filter, JSONModel, Button, StandardListItem, List, Toolbar, FilterUtil, FilterOperator) {
	"use strict";
	...
	sap.suite.ui.generic.template.AnalyticalListPage.controller.DropDownController.createDropdown = function(oControl, oChart, oModel, title, property, bIsEntitySearchable) {
		...
		oList = sap.suite.ui.generic.template.AnalyticalListPage.controller.DropDownController.createStandardListItem(oModel, oChart, i18n, title, property, oToolbarMenuButton, filterBy),
		oDialog = sap.suite.ui.generic.template.AnalyticalListPage.controller.DropDownController.createPopoverWithList(oModel, oChart, i18n, property, title, oList, filterBy, oToolbarMenuButton, bIsEntitySearchable),
	...
	sap.suite.ui.generic.template.AnalyticalListPage.controller.DropDownController.createPopoverWithList = function(oModel, oChart, i18n, property, title, oList, filterBy, oToolbarMenuButton, bIsEntitySearchable) {
	...
	sap.suite.ui.generic.template.AnalyticalListPage.controller.DropDownController.createStandardListItem = function(oModel, oChart, i18n, title, property, oToolbarMenuButton, filterBy) {
