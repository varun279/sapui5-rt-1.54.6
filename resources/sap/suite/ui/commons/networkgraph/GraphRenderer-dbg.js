sap.ui.define([
	...
	return {
		...
		render: function (oRM, oNetworkGraph) {
			...
			oRM.write("<div class=\"sapSuiteUiCommonsNetworkGraph " + sLayeredClass + " \" tabindex=\"0\"");
			...
			oRM.write("<p class=\"sapSuiteUiCommonsNetworkAlertText\">" + jQuery.sap.encodeHTML(oResourceBundle.getText("NETWORK_GRAPH_ZOOMCTRL")) + "</p>");
			oRM.write("</div>");
