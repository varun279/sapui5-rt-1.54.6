...
//				sap.ovp.cards.charts.VizAnnotationManager.hideDateTimeAxis(vizFrame);
        ...
        onAfterRendering: function () {
            if (!sap.ovp.cards.OVPCardAsAPIUtils.checkIfAPIIsUsed(this) && this.getCardPropertiesModel().getProperty("/layoutDetail") === "resizable") {
		...
		onDataReceived: function(oEvent) {
			...
			if (!this.isVizPropSet) {
				...
				sap.ovp.cards.charts.VizAnnotationManager.buildVizAttributes(vizFrame, handler, chartTitle, this);
			...
			sap.ovp.cards.charts.VizAnnotationManager.setChartUoMTitle(vizFrame,vizData,chartScaleTitle);
			if (this.bFlag == true) {
...
//            var handler = vizFrame.getParent();
        ...
        resizeCard: function (newCardLayout) {
            ...
            if (!this.isVizPropSet) {
                sap.ovp.cards.charts.VizAnnotationManager.buildVizAttributes(vizCard, handler, chartTitle, this);
                this.isVizPropSet = true;
                if (bubbleText != undefined) {
