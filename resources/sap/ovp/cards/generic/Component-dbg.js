sap.ui.define(["sap/ui/core/UIComponent", "sap/ovp/cards/AnnotationHelper", "sap/ovp/cards/LoadingUtils",
        "sap/ovp/cards/CommonUtils"],

    function (UIComponent, AnnotationHelper, LoadingUtils, CommonUtils) {
        "use strict";
            ...
            getPreprocessors: function (pOvplibResourceBundle) {
                ...
                if (oCardProperties.state !== "Loading") {
                    ...
                    if (oSettings && oSettings.kpiAnnotationPath) {
                        ...
                        if (oKpiAnnotation && contentFragment === "sap.ovp.cards.charts.analytical.analyticalChart") {
                            var sSelectionVariantPath = oKpiAnnotation.SelectionVariant && oKpiAnnotation.SelectionVariant.Path;
                            if (sSelectionVariantPath) {
                                this.setSelectionVariant(sSelectionVariantPath, oSettings);
                            }
                            var sPresentationVariantPath = oKpiAnnotation.Detail.DefaultPresentationVariant && oKpiAnnotation.Detail.DefaultPresentationVariant.Path;
                            if (sPresentationVariantPath) {
                                this.setPresentationVariant(sPresentationVariantPath, oSettings, oEntityType);
                            }
                            var sDataPointAnnotationPath = oKpiAnnotation.DataPoint && oKpiAnnotation.DataPoint.Path;
                ...
                var ovpConstantsModel = new sap.ui.model.json.JSONModel(sConstants);
