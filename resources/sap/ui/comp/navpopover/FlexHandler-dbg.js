...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/comp/library', 'sap/ui/base/ManagedObject', 'sap/ui/comp/personalization/Util', './Util', './Factory', 'sap/ui/comp/personalization/Controller', 'sap/ui/comp/personalization/SelectionWrapper'
], function(jQuery, CompLibrary, ManagedObject, PersonalizationUtil, Util, Factory, Controller, SelectionWrapper) {
	"use strict";
	 ...
	 * @private
	 */
	FlexHandler.prototype.openSelectionDialog = function(oSelectorControl, bForbidNavigation, bShowReset, fCallbackAfterClose, bIsEndUser, sStyleClass) {
		var that = this;
		...
		return new Promise(function(resolve) {
			...
			var oController = new Controller({
				table: SelectionWrapper.createSelectionWrapper(Util.getStorableAvailableActions(FlexHandler._convertSnapshotToObjectArray(oSnapshotOrigin)), bForbidNavigation),
