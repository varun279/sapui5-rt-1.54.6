...
sap.ui.define([
	'jquery.sap.global', 'sap/m/Link', 'sap/m/ResponsivePopover', 'sap/m/Button', 'sap/m/Title', 'sap/m/Image', 'sap/m/Text', 'sap/ui/layout/form/SimpleForm', 'sap/m/VBox', 'sap/m/HBox', 'sap/m/ResponsivePopoverRenderer', './Factory', './LinkData', 'sap/ui/model/json/JSONModel', 'sap/ui/base/ManagedObjectObserver'
], function(jQuery, Link, ResponsivePopover, Button, Title, Image, Text, SimpleForm, VBox, HBox, ResponsivePopoverRenderer, Factory, LinkData, JSONModel, ManagedObjectObserver) {
	"use strict";
