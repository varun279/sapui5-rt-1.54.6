		...
		if (oData && oFilterItem && oControl) {
			if (!oFilterItem.data("isCustomField")) {
				...
				if ((oCustomData !== undefined) && (oCustomData != null)) {
					...
					if (oControl.getSelectedKey) { // new mechanism with 1.25. Has to be provided by the custom field
					...
					if (oControl.getSelectedKeys) { // convenient check for MCB custom controls
