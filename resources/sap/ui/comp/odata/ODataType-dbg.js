...
sap.ui.define([
	...
	var ODataType = {
		 ...
		 * @param {boolean} bStringDate if <code>true</code> it is the new StringDate {@link sap.ui.model.type.StringDate} if <code>false</code> the type is defined by the Edm.type
		 ...
		 * @returns {boolean} true|false
		 */
		isDateOrTime: function(sType, bIsStringDate) {
			if (bIsStringDate) {
				return true;
			}
