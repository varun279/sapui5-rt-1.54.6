...
sap.ui.define([
	...
	/**
	 * Exports all the relevant data contained in the freehand redline element to an SVG object.
	 * @returns {object} Data that can be used to restore the freehand redline element.
	 * @public
	 */
	RedlineElementFreehand.prototype.exportSVG = function() {
		...
		var svgFreehand = "http://www.w3.org/2000/svg";
		var freehand = document.createElementNS(svgFreehand, "path");

		freehand.setAttributeNS(null, "d", this.getPath());

		// redlineElement attributes
		freehand.setAttributeNS(null, "stroke", redlineElementAttr.strokeColor);
		freehand.setAttributeNS(null, "stroke-width", redlineElementAttr.strokeWidth);
		freehand.setAttributeNS(null, "x", redlineElementAttr.originX);
		freehand.setAttributeNS(null, "y", redlineElementAttr.originY);

		return freehand;
	};

	/**
	 * Imports data from SVG into the redline element.
	 * @param {object} svg Relevant data that can be used to restore the freehand redline element.
	 * @returns {sap.ui.vk.RedlineElementFreehand} <code>this</code> to allow method chaining.
	 * @public
	 */
