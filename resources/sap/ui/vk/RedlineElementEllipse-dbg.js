...
sap.ui.define([
	...
	/**
	 * Exports all the relevant data contained in the ellipse redline element to an SVG object.
	 * @returns {object} Data that can be used to restore the ellipse redline element.
	 * @public
	 */
	RedlineElementEllipse.prototype.exportSVG = function() {
		...
		var svgEllipse = "http://www.w3.org/2000/svg";
		var ellipse = document.createElementNS(svgEllipse, "ellipse");

		ellipse.setAttributeNS(null, "rx", this.getRadiusX());
		ellipse.setAttributeNS(null, "ry", this.getRadiusY());
		ellipse.setAttributeNS(null, "fill", this.getFillColor());

		// redlineElement attributes
		ellipse.setAttributeNS(null, "stroke", redlineElementAttr.strokeColor);
		ellipse.setAttributeNS(null, "stroke-width", redlineElementAttr.strokeWidth);
		ellipse.setAttributeNS(null, "x", redlineElementAttr.originX);
		ellipse.setAttributeNS(null, "y", redlineElementAttr.originY);

		return ellipse;
	};

	/**
	 * Imports data from an SVG object into the ellipse redline element.
	 * @param {object} svg Relevant data used to restore the ellipse redline element.
	 * @returns {sap.ui.vk.RedlineElementEllipse} <code>this</code> to allow method chaining.
	 * @public
	 */
