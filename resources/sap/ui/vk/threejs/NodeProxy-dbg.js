...
sap.ui.define([
	...
	NodeProxy.prototype.getMaterialId = function() {
		...
		if (this._object3D.material !== undefined &&
			this._object3D.material.userData !== undefined &&
			this._object3D.material.userData.materialId !== undefined){
			return this._object3D.material.userData.materialId;
		} else if (this._object3D.userData.originalMaterial !== undefined &&
				this._object3D.userData.originalMaterial.userData !== undefined &&
				this._object3D.userData.originalMaterial.userData.materialId !== undefined) {
				return this._object3D.userData.originalMaterial.userData.materialId;
		}
	...
	NodeProxy.prototype._updateAncestorsBoundingBox = function() {
		...
		while (parent) {
			if (parent.userData.boundingBox !== undefined) {
				parent._calculateObjectOrientedBoundingBox();
			}
